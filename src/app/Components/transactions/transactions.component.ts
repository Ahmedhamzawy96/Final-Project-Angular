...
export class TransactionsComponent implements OnInit {
 ...
 // UpdatTrans =new this.UpdatTrans();
  ...
  addTrans()
  {
    this.Trans.addtransaction(this.UserTransaction.value).subscribe((res:ITransactions)=>
      {
  ...
  UpdateTrans()
  {
  this.Trans.updatetransaction(this.id,this.UserTransaction.value).subscribe((upd:ITransactions)=>
  {
...
{ 
...

  {
     ...
     console.log(this.id);
       this.Trans.deletetransaction(this.id)
       .subscribe(Date=>
         {
